...
- `BadOpcodeException` - When a message received has an invalid opcode
...
- `CloseException` - Connection is open but must be closed without any messages sent or received
- `ReconnectException` - Connection is open but must reconnect
